      ...
      <div className="bg-black lg:py-20">
        <div className="container">
          <div className="grid grid-cols-12 lg:gap-10 items-center">
            ...
            <div className="col-span-12 lg:col-span-6 mt-20 lg:mt-0">
              <div className="">
                ...
                {features.length > 0 ? (
                  ...
                  <p className="text-center text-white opacity-70! font-pro-display mt-8">
                ...
                {button && (
                  <div className="mt-8">
                    <Link
                      to={button.link}
                      className="inline-flex items-center justify-center bg-[linear-gradient(256.9deg,#B18325_6.41%,#D7BF75_98.66%)]! rounded-[50px] text-xl w-43.25 h-14.5 text-black font-semibold!"
                    >
                      {button.label}
                    </Link>
                  </div>
            ...
            {/* right Panel */}
            <div className="col-span-12 lg:col-span-6 mt-10 xl:mx-auto lg:mt-0">
